    ...
    >
      <div className="flex-shrink-0 w-full sm:w-60 md:w-96 lg:w-auto lg:max-w-lg xl:max-w-xl lg:flex lg:items-center pb-5 md:pb-8 lg:pb-12 xl:pb-16">
        <div className="py-4 md:py-6 xl:py-8 text-center sm:text-start">
          ...
          <h2
            className="text-heading text-md ssm:text-xl md:text-2xl xl:text-3xl 2xl:text-4xl font-normal leading-7 sm:leading-8 md:leading-snug xl:leading-relaxed 2xl:leading-snug mb-6 md:mb-8 lg:mb-9 xl:mb-12 2xl:mb-14 lg:pe-20 2xl:pe-0"
            dangerouslySetInnerHTML={{
              __html: t(`1. ${subTitle}`),
            }}
          />
          <h2
            className="text-heading text-md sm:text-xl md:text-2xl xl:text-3xl 2xl:text-4xl font-normal leading-7 sm:leading-8 md:leading-snug xl:leading-relaxed 2xl:leading-snug mb-6 md:mb-8 lg:mb-9 xl:mb-12 2xl:mb-14 lg:pe-20 2xl:pe-0"
            dangerouslySetInnerHTML={{
              __html: t(`2. ${subTitle}`),
            }}
          />
