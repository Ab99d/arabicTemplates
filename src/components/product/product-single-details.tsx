    ...
    <div className='block lg:grid grid-cols-9 gap-x-10 xl:gap-x-14 pt-7 pb-10 lg:pb-14 2xl:pb-20 items-start'>
      {width < 1025 ? (
            ...
            <SwiperSlide key={`product-gallery-key-${index}`}>
              <div className='col-span-1 transition duration-150 ease-in hover:opacity-90'>
                <img
                  src={
                    item?.original ??
                    "/assets/placeholder/products/dummy-images/19.jpg"
                  }
                  alt={`${data?.name}--${index}`}
        ...
        <div className='col-span-5'>
          <Swiper className='grid grid-cols-2 gap-2.5'>
            <SwiperSlide className='col-span-2 transition duration-150 ease-in hover:opacity-90'>
              <img
                src={"/assets/images/products/dummy-images/19.jpg"}
                // alt={`${data?.name}--${index}`}
                className='object-cover w-full'
              />
            </SwiperSlide>
            <SwiperSlide className='col-span-2 transition duration-150 ease-in hover:opacity-90'>
              <img
                src={"/assets/images/products/dummy-images/20.jpg"}
                // alt={`${data?.name}--${index}`}
                className='object-cover w-full'
              />
            </SwiperSlide>
            <SwiperSlide className='col-span-2 transition duration-150 ease-in hover:opacity-90'>
              <img
                src={"/assets/images/products/dummy-images/2.jpg"}
                // alt={`${data?.name}--${index}`}
                className='object-cover w-full'
              />
            </SwiperSlide>
            <SwiperSlide className='col-span-2 transition duration-150 ease-in hover:opacity-90'>
              <img
                src={"/assets/images/products/dummy-images/22.jpg"}
                // alt={`${data?.name}--${index}`}
                className='object-cover w-full'
              />
            </SwiperSlide>
