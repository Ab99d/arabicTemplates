...
const CategoryMenuLink: React.FC<CategoryMenuProps> = ({
  className,
  categoryMenu,
}) => {
  ...
  return (
    <div className={cn('relative flex-shrink-0 categoryMenu', className)}>
      <div className='flex items-center py-7 justify-center gap-2 px-3.5 xl:px-4 text-sm relative before:absolute before:-bottom-2.5 before:h-2.5 before:w-full before:z-10 font-semibold text-[#212121] hover:text-[#2C68F6] transition-colors rounded-md cursor-pointer h-11'>
